...
C {BUFF/BUFF.sym} -270 -170 0 0 {name=x5}
C {BUFF/BUFF.sym} -400 -70 0 0 {name=x6}
C {DFF/DFF.sym} -520 -120 0 0 {name=x1}
C {OSC/OSC.sym} -450 160 0 0 {name=x4}
C {OSC/OSC.sym} 50 130 0 0 {name=x3}
C {TGATE/TGATE.sym} -580 80 0 0 {name=x7}
C {TGATE/TGATE.sym} -70 -50 0 0 {name=x2}
